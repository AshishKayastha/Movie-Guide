...
import com.ashish.movies.data.database.tables.OMDbTable.COL_AWARDS
import com.ashish.movies.data.database.tables.OMDbTable.COL_COUNTRY
import com.ashish.movies.data.database.tables.OMDbTable.COL_IMDB_ID
import com.ashish.movies.data.database.tables.OMDbTable.COL_IMDB_RATING
import com.ashish.movies.data.database.tables.OMDbTable.COL_IMDB_VOTES
import com.ashish.movies.data.database.tables.OMDbTable.COL_LANGUAGE
import com.ashish.movies.data.database.tables.OMDbTable.COL_MEDIA_ID
import com.ashish.movies.data.database.tables.OMDbTable.COL_METASCORE
import com.ashish.movies.data.database.tables.OMDbTable.COL_PRODUCTION
import com.ashish.movies.data.database.tables.OMDbTable.COL_RATED
import com.ashish.movies.data.database.tables.OMDbTable.COL_TOMATO_IMAGE
import com.ashish.movies.data.database.tables.OMDbTable.COL_TOMATO_METER
import com.ashish.movies.data.database.tables.OMDbTable.COL_TOMATO_RATING
