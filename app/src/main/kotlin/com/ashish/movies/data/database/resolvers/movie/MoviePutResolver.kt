 ...
 */
open class MoviePutResolver : DefaultPutResolver<MovieEntity>() {
    ...
    override fun mapToContentValues(movieEntity: MovieEntity) = movieEntity.toContentValues()
}

fun MovieEntity.toContentValues(): ContentValues {
