...
public class InkPageIndicator extends View implements ViewPager.OnPageChangeListener,
    ...
    public InkPageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        int unselectedColor = a.getColor(R.styleable.InkPageIndicator_pageIndicatorColor, DEFAULT_UNSELECTED_COLOUR);
        int selectedColor = a.getColor(R.styleable.InkPageIndicator_currentPageIndicatorColor, DEFAULT_SELECTED_COLOUR);
